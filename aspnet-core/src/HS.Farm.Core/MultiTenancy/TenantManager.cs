...
using HS.Farm.MultiTenancy.Demo;
using Abp.Extensions;
using Abp.Notifications;
using Abp.Runtime.Security;
using Microsoft.AspNetCore.Identity;
using HS.Farm.Notifications;
using System;
using System.Diagnostics;
using System.Linq.Expressions;
using Abp.UI;
using Microsoft.EntityFrameworkCore;
using HS.Farm.MultiTenancy.Payments;
...
namespace HS.Farm.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(FarmConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
